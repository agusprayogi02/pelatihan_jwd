...
<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" src="<?= baseURL('dist/img/AdminLTELogo.png') ?>" alt="AdminLTELogo" height="60"
             width="60">
    </div>
    ...
    <aside class="main-sidebar sidebar-dark-success elevation-4">
        ...
        <a href="index.php" class="brand-link">
            <img src="<?= baseURL('image/koi.jpg') ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="<?= baseURL('dist/img/user2-160x160.jpg') ?>" class="img-circle elevation-2"
                         alt="User Image">
                </div>
                <div class="info">
                        ...
                        if ($_SESSION['level'] === "admin") :
                            ...
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="admin/index.php?page=tambahKoi" class="nav-link">
